...
object ProjectBackupCodec {
    ...
    private fun project(o: JSONObject) = NovelProject(
        ...
        forbiddenContent = o.s("forbiddenContent"), automationLevel = o.s("automationLevel").ifBlank { "半自动" }, targetChapterWordCount = o.optInt("targetChapterWordCount", 2000), targetChapterWordCountMax = o.optInt("targetChapterWordCountMax", 3500),
