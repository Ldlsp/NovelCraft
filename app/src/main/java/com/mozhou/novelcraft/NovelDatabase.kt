...
data class NovelProject(
    ...
    @ColumnInfo(defaultValue = "5000") val targetChapterWordCountMax: Int = 3500,
    ...
    companion object {
        ...
        private val MIGRATION_23_24 = object : Migration(23, 24) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("UPDATE projects SET targetChapterWordCount = 2000 WHERE targetChapterWordCount < 2000")
                db.execSQL("UPDATE ideation_drafts SET targetChapterWordCount = 2000 WHERE targetChapterWordCount < 2000")
            }
        }
        private val MIGRATION_24_25 = object : Migration(24, 25) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("UPDATE projects SET targetChapterWordCount = 2000 WHERE targetChapterWordCount = 3000")
                db.execSQL("UPDATE ideation_drafts SET targetChapterWordCount = 2000 WHERE targetChapterWordCount = 3000")
            }
        }
